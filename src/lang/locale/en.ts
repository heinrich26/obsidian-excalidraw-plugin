...
export default {
  ...
  LATEX_PREAMBLE_DESC: "Full filepath to the preamble file, leave blank to ignore. If the file doesn't exist this option will be ignored.<br>This preamble is loaded in addition to any other preamble, e.g. by <i>Extended MathJax</i>.<br><strong>Important:</strong> Requires obsidian reload after change to take effect!",
